...
<?php
    ...
    if($_POST){
        ...
        if($catName!=""){
            $sql = "SELECT * FROM category WHERE title='$catName';";
            ...
            if(mysqli_num_rows($res)!=0){
                ...
                $query = "INSERT INTO category (title,active) VALUES (\"$catName\", \"$active\");";
                ...
                if($res){
                    ...
                    <div class="alert alert-success">
                        <h4>Category Saved</h4>
                        <h6>category saved successfully</h6>
                    </div>
                </div>';
                }else{
                    echo "failed";
                    ...
                    <div class="table-wrapper form-wrapper">
                        <form id="myForm" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Name" name="catName" id="catName" required>
                            </div>
